...
class Category(models.Model):
    '''Категории'''
    name = models.CharField("Категория", max_length=150, default='')
    description = models.TextField("Описание", default='')
    url = models.SlugField(max_length=100, unique=True, default='')
...
class MovieShots(models.Model):
    '''Кадры из фильма'''
    title = models.CharField('Зоголовок', max_length=100)
    description = models.TextField("Описание")
